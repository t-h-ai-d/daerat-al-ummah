...
const sections = [
  ...
  },
  {
    ...
    body: "لا توجد نافذة بلاغات أو مساحة إشراف ظاهرة للأعضاء. للإبلاغ عن احتيال أو كذب أو محتوى مُفسِد للعقل أو صور محرمة، يفتح الموقع رسالة بريد إلى ssbmbwuugame@gmail.com؛ ارسل الضروري فقط وبصدق. قد يضع الفحص الآلي الحذر منشوراً واضح الخطر قيد مراجعة بشرية، لكنه لا يصدر فتوى ولا حذفاً أو عقوبة نهائية تلقائياً.",
  },
  {
    icon: LockKeyhole,
  ...
  },
  {
    ...
    body: "يمكنك تعديل ملفك وحذف محتواك الذي تملكه، وإرسال بلاغ أو طلب مساعدة بشأن الحساب أو الخصوصية عبر البريد الظاهر في الموقع. نحتفظ بسجل محدود من فحص المنشورات عند الحاجة إلى مراجعة بشرية أو منع الاحتيال، بما في ذلك سبب الفحص وحالته، ولا نعتمد عليه لقرار ديني أو عقوبة نهائية تلقائية.",
  },
];
