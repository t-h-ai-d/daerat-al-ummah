...
const sections = [
  ...
  },
  {
    ...
    body: "نستخدم كلمات مرور مُشفَّرة وجلسات موقّعة وضوابط صلاحيات لحماية الحسابات. كما تُحفظ مراجع المرفقات في تخزين مخصص للخدمة. قد تُفحَص نصوص المنشورات العامة أو منشورات المساحات تلقائياً بحثاً عن أنماط سبام أو احتيال واضحة؛ ولا تُفحَص الرسائل الخاصة بهذه الآلية. لا توجد خدمة رقمية خالية تماماً من المخاطر؛ احمِ كلمة مرورك ولا تشارك رمز الجلسة أو بيانات الدخول مع أحد.",
  },
  {
    icon: AlertTriangle,
    title: "٥. البلاغات وفحص المنشورات",
    body: "لا توجد مساحة إشراف ظاهرة للأعضاء. للإبلاغ عن احتيال أو كذب أو محتوى مُفسِد للعقل أو صور محرمة، افتح قائمة النقاط الثلاث في منشور عضو آخر واختر «الإبلاغ عن المنشور». يُسجَّل البلاغ ويُسلَّم من خادم المنصة إلى بريد المالك ssbmbwuugame@gmail.com، من دون فتح تطبيق بريدك الشخصي. قد يضع الفحص الآلي الحذر منشوراً واضح الخطر قيد مراجعة بشرية، لكنه لا يصدر فتوى ولا حذفاً أو عقوبة نهائية تلقائياً.",
  },
  {
    icon: LockKeyhole,
    title: "٦. الإشعارات والإشارات",
    body: "ننشئ إشعارات عند المتابعة والإعجاب والتعليق وإعادة النشر والإشارة باسم المستخدم، وقد يصلك إشعار خاص بحالة منشورك إذا أوقفه الفحص الحذر للمراجعة. الغرض منها إبلاغك بالنشاط المرتبط بك، لا دفعك إلى التمرير القهري أو جمع التفاعل. يمكنك ببساطة تقليل استخدامك أو مراجعة الإشعارات على فترات تناسبك.",
  },
  {
    icon: CheckCircle2,
  ...
  },
  {
    ...
    body: "يمكنك تعديل ملفك وحذف محتواك الذي تملكه، وإرسال بلاغ من قائمة المنشور داخل المنصة. كما يمكنك طلب مساعدة بشأن الحساب أو الخصوصية عبر بيانات التواصل الظاهرة في الموقع. نحتفظ بسجل محدود من فحص المنشورات والبلاغات عند الحاجة إلى مراجعة بشرية أو منع الاحتيال، بما في ذلك سبب الفحص وحالته، ولا نعتمد عليه لقرار ديني أو عقوبة نهائية تلقائية.",
  },
];
