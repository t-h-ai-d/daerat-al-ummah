  ...
  return (
    <main dir="rtl" lang="ar" className="min-h-screen bg-[#f5f5ef] px-4 py-8 text-[#16352d] sm:grid sm:place-items-center sm:p-8">
      <section className="w-full max-w-[460px] overflow-hidden rounded-[28px] border border-[#d9e3d8] bg-[#fcfdf9] shadow-[0_24px_70px_rgba(12,57,43,0.12)]">
        <div className="relative overflow-hidden bg-[#0d3b31] px-7 pb-7 pt-8 text-[#f8f7ed]"><div className="geometric-orb" aria-hidden="true" /><div className="relative"><span className="grid h-11 w-11 place-items-center rounded-2xl bg-[#d6b454] text-[#123b31]"><UserRound size={21} /></span><p className="mt-5 text-[10px] font-bold tracking-[0.18em] text-[#e7c669]">أُمَّة سيركل</p><h1 className="mt-2 font-display text-3xl font-semibold">ادخل إلى دائرتك</h1><p className="mt-2 text-sm leading-6 text-[#cbdcd3]">حسابك ملكك: بريد إلكتروني، اسم مستخدم، وكلمة مرور فقط.</p></div></div>
