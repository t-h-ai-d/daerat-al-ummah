...
export function CommunityDetailPage() {
  ...
  const onFileSelect = async (event: React.ChangeEvent<HTMLInputElement>) => {
    ...
    if (file.size > 1073741824) return toast.error("الحد المشترك لكل مرفق هو 1 غيغابايت.");
