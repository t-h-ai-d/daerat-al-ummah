...
function PostCard({ post, isAuthor, onLike, onRepost, onComment, onReport, onDelete, onEdit, onSetVisibility }: { post: FeedPost; isAuthor: boolean; onLike: () => void; onRepost: () => void; onComment: () => void; onReport: () => void; onDelete: () => void; onEdit: () => void; onSetVisibility: (visibility: "public" | "friends") => void }) {
