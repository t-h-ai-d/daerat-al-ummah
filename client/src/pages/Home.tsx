...
export default function Home() {
  ...
  const savePost = trpc.social.toggleSavedPost.useMutation({ onSuccess: result => { void utils.social.feed.invalidate(); toast.success(result.saved ? "حُفِظَ المنشور في إشاراتك." : "أُزيل المنشور من إشاراتك."); }, onError: error => toast.error(error.message) });
